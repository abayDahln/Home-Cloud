...
const Download = () => {
    ...
    const platforms = [
        {
            ...
            version: 'v1.0.0', size: '~25 MB', fileName: 'HomeCloud-v1.0.0.apk',
            downloadUrl: '#', available: true, popular: true,
        ...
        },
        {
            ...
            version: 'v1.0.0', size: '~30 MB', fileName: 'App Store',
        ...
        },
        {
            ...
            version: 'v1.0.0', size: '~45 MB', fileName: 'HomeCloud-v1.0.0-windows.exe',
            downloadUrl: '#', available: true, popular: false,
        ...
        },
        {
            ...
            version: 'v1.0.0', size: '~40 MB', fileName: 'HomeCloud-v1.0.0.AppImage',
            downloadUrl: '#', available: true, popular: false,
    ...
    const serverDownloads = [
        { name: t.download.serverDownload.name, icon: '📦', fileName: 'homecloud-server.zip', downloadUrl: '#', description: t.download.serverDownload.desc },
    ]
            ...
            <section className="py-16 px-6 lg:px-8">
                ...
                >
                    <motion.h1 variants={glideV} className="text-4xl md:text-6xl font-extrabold text-textBlack mb-4 tracking-tight">
                        {t.download.title}{' '}
                        <span className="gradient-text">HomeCloud</span>
                    </motion.h1>
                    ...
                    {serverDownloads.map((server, index) => (
                        ...
                        >
                            <div className="flex flex-col sm:flex-row">
                                ...
                                <div className="relative bg-gradient-to-br from-primary to-primary-dark2 px-10 py-8 sm:py-10 sm:w-48 flex-shrink-0 flex items-center justify-center overflow-hidden">
                                    {/* Decorative circles */}
                                ...
                                {/* Right content */}
                                <div className="flex-1 bg-white p-6 sm:p-8 flex flex-col sm:flex-row items-center gap-5">
                                    <div className="flex-1 text-center sm:text-left">
                                        <h3 className="font-extrabold text-textBlack text-lg mb-1">{server.name}</h3>
                                        <p className="text-sm text-gray font-light leading-relaxed">{server.description}</p>
                                    </div>
                                        ...
                                        <AnimatePresence mode="wait">
                                            {serverCompleted[index] ? (
                                                ...
                                                <motion.button
                                                    ...
                                                    whileHover={{ scale: 1.03 }}
                                                    whileTap={{ scale: 0.97 }}
                                                    className="relative w-full overflow-hidden bg-primary text-white font-bold py-3 px-8 rounded-xl group flex items-center justify-center gap-2"
                                                >
                                                    <span className="absolute inset-0 bg-primary-dark1 translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-out rounded-xl" />
