...
const Download = () => {
    ...
    const platforms = [
        {
            ...
            version: 'v1.0.0', size: '~50 MB', fileName: 'HomeCloud-Android.apk',
        ...
        },
        {
            ...
            version: 'v1.0.0', size: '~40 MB', fileName: 'HomeCloud-iOS.ipa',
        ...
        },
        {
            ...
            version: 'v1.0.0', size: '~25 MB', fileName: 'HomeCloudApp-Windows.exe',
        ...
        },
        {
            ...
            version: 'v1.0.0', size: '~20 MB', fileName: 'HomeCloudApp-Linux.AppImage',
            downloadUrl: 'https://github.com/abayDahln/Home-Cloud/releases/download/Release/HomeCloudApp.AppImage', available: true, popular: false,
    ...
    const serverDownloads = [
        ...
        },
        {
            ...
            fileName: 'HomeCloudServer-Linux.AppImage',
            downloadUrl: 'https://github.com/abayDahln/Home-Cloud/releases/download/Release/HomeCloudServer-Linux.AppImage',
