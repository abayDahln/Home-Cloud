...
class SyncTaskHandler extends TaskHandler {
  ...
  Future<void> onStart(DateTime timestamp, TaskStarter starter) async {
    ...
    final savedTimestamp = prefs.getInt('foreground_sync_start_time');
    ...
    debugPrint(
        '🚀 [ForegroundSync] Service started. Monitoring from $_monitoringStartTime');
  }
      ...
      for (var folder in settings.folders) {
        ...
        await for (final entity in dir.list(recursive: true)) {
          ...
          try {
            ...
            await _dio!.post('/upload$query', data: formData);
